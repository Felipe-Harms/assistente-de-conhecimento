...
# Gera os artefatos de prova REQ-005 (ingest do corpus + 12 perguntas de
# aceitação + respostas citadas + lacunas). Requer a stack ativa.
# Popula o diretório `proof/` no host (via volume mount no serviço `test`).
